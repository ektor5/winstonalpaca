const BROWSER_JS_T = {
    nothingFoundForXxx: query => 'Nessun risultato trovato per \'{query}\''.replace('{query}',query),
    showingFeaturedItems: 'Mostrando gli elementi in evidenza',
    showingXxxResultsForXxx: (count,query) => 'Mostrando {count} risultati per \'{query}\''.replace('{count}',count).replace('{query}',query),
    xxxAndOthers: (xxx,othersLink) => '{xxx} e <a href="{others_link}">altri</a>'.replace('{xxx}',xxx).replace('{others_link}',othersLink)
};
const LABEL_MODE = false;
const ARTISTS = [];
const RELEASES = [{cover:'cover_160.jpg?mc_Rs3i7ocw',title:'Winston Alpaca',tracks:[{cover:'cover_160.jpg?qMF4hsoYz2Q',number:'1.',title:'Pop Rock',url:'home/1/'},{cover:'cover_160.jpg?ajC2RPg_FY0',number:'2.',title:'Colla',url:'home/2/'},{cover:'cover_160.jpg?IWTiyY6dazY',number:'3.',title:'Dea',url:'home/3/'}],url:'home/'}];
