const PLAYER_JS_T = {
    ...
    playerClosed: 'Lettore audio chiuso',
    playerOpenPlayingXxx: title => 'Lettore audio aperto, in riproduzione {title}'.replace('{title}', title),
    playerOpenWithXxx: title => 'Avvia il lettore con {title}'.replace('{title}', title),
    unmute: 'Riattiva audio',
    volume: 'Volume',
    xxxHours: hours => '{xxx} ore'.replace('{xxx}', hours),
    xxxMinutes: minutes => '{xxx} minuti'.replace('{xxx}', minutes),
    xxxSeconds: seconds => '{xxx} secondi'.replace('{xxx}', seconds)
};
